...
@app.route('/brands')
def get_all_brands():
    return jsonify(brands = data.get_all_brands())
...
def get_brands_by_name(name):
    return jsonify(brands = data.get_brands_by_name(name))

@app.route('/products')
def get_all_products():
    return jsonify(products = data.get_all_products())
...
def get_products_by_name(name):
    return jsonify(products = data.get_products_by_name(name))
